<script lang="ts">
  ...
  const { getAllGameSpaces, pubKey } = getContext();
</script>
  ...
  <div class="bg-white/10 p2 b b-white/10 rounded-md max-w-screen-sm mx-auto w-full flex">
    ...
    <div class="flex flex-col flex-grow">
      <div class="flexcs w-full h-8">
        <h2 class="text-xl flex-grow text-black/70">My game of Chess</h2>
        <button
      ...
      <div class="flex">
        <div class="flexcs flex-grow h8">
          <div
            ...
            >6/8</div
          >
          <PlayerStatus agent={pubKey} inRoom={true} isPlaying={true} isCreator={true} />
          <PlayerStatus agent={pubKey} inRoom={false} isPlaying={true} isCreator={false} />
          <PlayerStatus agent={pubKey} inRoom={true} isPlaying={true} isCreator={false} />
          <PlayerStatus agent={pubKey} inRoom={true} isPlaying={true} isCreator={false} />
          <PlayerStatus agent={pubKey} inRoom={true} isPlaying={false} isCreator={false} />
          <PlayerStatus agent={pubKey} inRoom={true} isPlaying={false} isCreator={false} />
          <PlayerStatus agent={pubKey} inRoom={true} isPlaying={false} isCreator={false} />
        </div>
        <button

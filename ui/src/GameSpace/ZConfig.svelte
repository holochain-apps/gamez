...
<div class="flex space-x-2 mb2">
  <div class="flex flex-grow">
    <button on:click={() => onMoveZ('top')} class={groupKlass}><DoubleArrowUpIcon /></button>
    <button on:click={() => onMoveZ('up')} class={groupKlass}><ArrowUpIcon /></button>
    <button on:click={() => onMoveZ('down')} class={groupKlass}
      ><ArrowUpIcon class="rotate-180" /></button
    >
    <button on:click={() => onMoveZ('bottom')} class={groupKlass}
      ><DoubleArrowUpIcon class="rotate-180" /></button
    >
  </div>
